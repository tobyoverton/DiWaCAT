...
class BeamPlotWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.XAxisHistogram.setFixedSize(int(windowWidth*0.48), int(windowHeight*0.3))
        self.XHistValues = [[[],[0]]]
        ...
        self.YAxisHistogram.setFixedSize(int(windowWidth*0.24), int(windowHeight*0.65))
        self.YHistValues = [[[],[0]]]
        #Remember this one is rotated!
        ...
        self.ScatterPlot.setFixedSize(int(windowWidth*0.48), int(windowHeight*0.65))
        self.XData = []
        self.YData = []
