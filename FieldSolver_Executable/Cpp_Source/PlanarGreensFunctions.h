...
void EigenvaluesCalculator(int sI, int sN, vector<vector<double>>& zeroesES, vector<vector<double>>& zeroesEA, vector<vector<double>>& zeroesHS, vector<vector<double>>& zeroesHA, double Ep, double Mu, double B2, double b, double c, double w, double acc)
{
...
void TotalForceMeshHDF5(vector <double>& Fz, vector <double>& Fx, vector <double>& Fy, int NParticle, double xi, double x0, double yi, double y0, double zi, double zetamin, double zetamax, double z0, vector<double>& x, vector<double>& y, vector<double>& zeta, vector<vector<double> >& zeroesES, vector<vector<double> >& zeroesEA, vector<vector<double> >& zeroesHS, vector<vector<double> >& zeroesHA, int sN, int sI, double Ep, double Mu, double B2, double b, double c, double w, vector<double> q)
{
			...
			for (int k = 0; k<xValues.size(); k++) {
				...
				for (int l = 0; l<yValues.size(); l++)
				{
					...
					for (int m = 0; m<xValues.size(); m++)
					{
						...
						double deltaFz(0), deltaFx(0), deltaFy(0);
						CalcWakeElement(deltaFz, deltaFx, deltaFy, xCalcPoint, xGreen, yCalcPoint, yGreen, zValues[i], zValues[0], zeroesES, zeroesEA, zeroesHS, zeroesHA, sN, sI, Ep, Mu, B2, b, c, w);
						vector<double> Calculations = { deltaFx, deltaFy, deltaFz };
						/*
...
void TotalForceMeshHDF5VerticalPlate(vector <double>& Fz, vector <double>& Fx, vector <double>& Fy, int NParticle, double xi, double x0, double yi, double y0, double zi, double zetamin, double zetamax, double z0, vector<double>& x, vector<double>& y, vector<double>& zeta, vector<vector<double> >& zeroesES, vector<vector<double> >& zeroesEA, vector<vector<double> >& zeroesHS, vector<vector<double> >& zeroesHA, int sN, int sI, double Ep, double Mu, double B2, double b, double c, double w, vector<double> q)
{
	TotalForceMeshHDF5(Fz, Fy, Fx, NParticle, xi, x0, yi, y0, zi, zetamin, zetamax, z0, y, x, zeta, zeroesES, zeroesEA, zeroesHS, zeroesHA, sN, sI, Ep, Mu, B2, b, c, w, q);
}
